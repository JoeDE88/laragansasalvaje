    ...
    return (
        <>
            <Grid container spacing={2}>
                <Grid size={{sx:6,md:7}} >
                    <BlogItem bgColor={'secondary.main'} titulo={blogElement1.titulo} texto={blogElement1.texto} ></BlogItem>
                </Grid>
                <Grid size={{sx:6,md:5}}>
                    <Stack spacing={2}>
                        {slicedBlog.map((blog) => {
                            return (
                                ...
                                <Box sx={{ backgroundColor: 'gold' }}>
                                    <Collapse collapsedSize={200}>
                                        <BlogItem bgColor={'secondary.main'} titulo={blog.titulo} texto={blog.texto}></BlogItem>
                                    </Collapse>
                                </Box>
                                    <Button>Hola</Button>
                                </>
